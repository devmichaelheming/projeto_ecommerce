<form class="form-horizontal" id="form" role="form" method="post" action="{{ url('admin/usuarios/editar/save') }}/{{ $id }}" enctype="multipart/form-data" >
	...
	<div class="conteudo-login" style="padding: 0rem 0 0.5rem 0">
        <div class="group-register" style="width:98%;">
            <div class="group">      
                <input type="text" name="name" id="name" class="name" value="{{ $name }}" required autocomplete="off">
        ...
        <div class="group-register" style="width:98%;">
            <div class="group">      
                <input type="email" name="email" id="email" class="email" value="{{ $email }}" required autocomplete="off">
                <span class="highlight"></span>
                <span class="bar"></span>
                <label>E-Mail</label>
            </div>
        ...
        <div class="group-register" style="width:98%;">
            <div class="group">      
                <input type="password" name="password" id="password" class="password" value="{{ $password }}" required autocomplete="off">
                <span class="highlight"></span>
                <span class="bar"></span>
                <label>Senha</label>
            </div>
